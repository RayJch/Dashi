...
public class YelpAPI {
    ...
    private static final String CONSUMER_KEY = "5L4y9hRcmTvzKFHcMuuvVw";
    private static final String CONSUMER_SECRET = "bRX4OMxMGzwL0hT1s9u5oZG5YO8";
    private static final String TOKEN = "kKPRr2HXYQXg0YiTJK-VQuE92Lz5CCjN";
    private static final String TOKEN_SECRET = "tzu6rhj5EoXuFaWrUUgLCTta4Hg";
